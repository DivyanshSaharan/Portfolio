    ...
    return (
        <section className="projects section" id="projects">
            ...
            <div className="projects__container container grid">
                ...
                <div className="project__content">
                    <div>
                        <i class='bx bxl-youtube services__icon'></i>
                        <h3 className="project__title">VibeCheck<br></br> YouTube Comment Analyzer</h3>
                    </div>
                    ...
                    <div className={toggleState === 2 ? "project__modal active-modal" : "project__modal"}>
                        <div className="project__modal-content">
                            ...
                            <h3 className="project__modal-title">Vibecheck</h3>
                            <p className="project__modal-description"><a href="https://yt-comment-analyser-frontend.onrender.com/" className="button button--flex project__link" target="_blank">Project Link</a><a href="https://github.com/DivyanshSaharan/YT-Comment-Analyser" className="button button--flex project__link" target="_blank">Source Code</a></p>

                            <ul className="project__modal-services grid">
                                <li className="project__modal-service">
                                    <i className="uil uil-check-circle services__modal-icon"></i>
                                    <p className="services__modal-info">
                                        Classified 1,000 YouTube comments per video with 93% sentiment analysis accuracy using a custom
                                        TensorFlow model.
                                    </p>
                                </li>
                                <li className="project__modal-service">
                                    <i className="uil uil-check-circle services__modal-icon"></i>
                                    <p className="services__modal-info">
                                        Delivered sentiment results and ratings in under 30 seconds per video, enabling rapid feedback analysis
                                        for creators.
                                    </p>
                                </li>
                                {/* <li className="project__modal-service">
